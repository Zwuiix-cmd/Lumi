...
public final class Fishing {
    ...
    public static final Selector TREASURE_BOW = putSelector(new EnchantmentItemSelector(Item.BOW, TREASURES, true), 0.1667F);
    public static final Selector TREASURE_ENCHANTED_BOOK = putSelector(new EnchantmentItemSelector(Item.ENCHANTED_BOOK, TREASURES, true), 0.1667F);
    public static final Selector TREASURE_FISHING_ROD = putSelector(new EnchantmentItemSelector(Item.FISHING_ROD, TREASURES, true), 0.1667F);
    ...
    public static Item getFishingResult(Item rod) {
        ...
        int lureLevel = 0;
        if (rod != null) {
            if (rod.hasEnchantment(Enchantment.ID_FORTUNE_FISHING)) {
                fortuneLevel = rod.getEnchantment(Enchantment.ID_FORTUNE_FISHING).getLevel();
            } else if (rod.hasEnchantment(Enchantment.ID_LURE)) {
