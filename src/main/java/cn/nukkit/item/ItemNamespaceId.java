...
public interface ItemNamespaceId {
    ...
    String CHALKBOARD = "minecraft:chalkboard";
    ...
    String DEPRECATED_ANVIL = "minecraft:deprecated_anvil";

    String DEPRECATED_PURPUR_BLOCK_1 = "minecraft:deprecated_purpur_block_1";

    String DEPRECATED_PURPUR_BLOCK_2 = "minecraft:deprecated_purpur_block_2";
