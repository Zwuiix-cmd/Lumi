...
public interface BlockID {
    ...
    int WAXED_WEATHERED_CHISELED_COPPER = 1021;
    int WAXED_OXIDIZED_CHISELED_COPPER = 1022;
    ...
    int COPPER_GOLEM_STATUE = 1294;
    int EXPOSED_COPPER_GOLEM_STATUE = 1295;
    int WEATHERED_COPPER_GOLEM_STATUE = 1296;
    int OXIDIZED_COPPER_GOLEM_STATUE = 1297;
    int WAXED_COPPER_GOLEM_STATUE = 1298;
    int WAXED_EXPOSED_COPPER_GOLEM_STATUE = 1299;
    int WAXED_WEATHERED_COPPER_GOLEM_STATUE = 1300;
    int WAXED_OXIDIZED_COPPER_GOLEM_STATUE = 1301;
    int OAK_SHELF = 1302;
