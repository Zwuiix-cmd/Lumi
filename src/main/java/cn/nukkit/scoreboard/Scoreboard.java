 ...
 *
 * @deprecated There is a more complete Scoreboard class in nukkit-mot. This class is only used to be compatible with nkx plugins.
...
public class Scoreboard {
    ...
    private void sendShowPacket(Player player) {
        ...
        objectivePacket.sortOrder = cn.nukkit.network.protocol.types.SortOrder.values()[this.sortOrder.ordinal()];
