...
public class RakNetInterface implements AdvancedSourceInterface {
    ...
    public RakNetInterface(Server server) {
        ...
        ServerBootstrap bootstrap = new ServerBootstrap()
                ...
                .option(RakChannelOption.RAK_SEND_COOKIE, this.server.getSettings().getNetwork().isEnableRakSendCookie())
                .option(RakChannelOption.RAK_PACKET_LIMIT, this.server.getSettings().getNetwork().getRakPacketLimit())
                .handler(new ChannelInitializer<>() {
                    @Override
                    protected void initChannel(Channel channel) {
                        if (server.getSettings().getNetwork().isEnableQuery()) {
