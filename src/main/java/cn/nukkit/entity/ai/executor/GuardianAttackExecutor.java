...
public class GuardianAttackExecutor implements EntityControl, IBehaviorExecutor {
    ...
    public boolean execute(EntityIntelligent entity) {
        ...
        if (tick2 == 0 && tick1 > coolDownTick) {
            ...
            if (tick2 > attackDelay) {
                if(entity.getDataPropertyLong(Entity.DATA_TARGET_EID) == target.getId()) {
    ...
    private void startSequence(Entity entity) {
        ...
        entity.level.addLevelSoundEvent(entity, LevelSoundEventPacket.SOUND_MOB_WARNING, -1, entity.getIdentifier().getNamespace(), false, false);
    }
