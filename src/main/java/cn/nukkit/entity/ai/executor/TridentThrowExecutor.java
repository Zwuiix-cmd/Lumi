...
public class TridentThrowExecutor implements EntityControl, IBehaviorExecutor {
    ...
    protected void throwTrident(EntityLiving entity) {
        ...
        Entity projectile = Entity.createEntity(EntityThrownTrident.NETWORK_ID, entity.level.getChunk(entity.getChunkX(), entity.getChunkZ()), nbt);
        ...
        if (projectev.isCancelled()) {
            ...
            entity.level.addSound(entity, Sound.ITEM_TRIDENT_THROW);
    ...
    private void playTridentAnimation(Entity entity) {
        ...
        entity.setDataFlag(Entity.DATA_FLAGS, Entity.DATA_FLAG_FACING_TARGET_TO_RANGE_ATTACK, true);
    }

    private void stopTridentAnimation(Entity entity) {
        entity.setDataProperty(new LongEntityData(DATA_TARGET_EID, 0));
